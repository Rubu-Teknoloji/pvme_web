...
import { fetchWebInfo, sendVideoTracking } from "../../redux/webInfoSlice/webInfoSlice";
            ...
            switch (mData.pageType) {
              ...
              case 1:
                return (
                  ...
                  videoRef={videoRef} handleVideoEnd={handleVideoEnd} videoLink={mData.videoUrl}/>
                );
              case 2:
                return (
                  <ImagePage 
                  ...
                  videoRef={videoRef} handleVideoEnd={handleVideoEnd} imageUrl={mData.imageUrl}
                                      onButtonClick={handleNextStep}
